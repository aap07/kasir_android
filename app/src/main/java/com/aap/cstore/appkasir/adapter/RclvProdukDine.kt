...
class RclvProdukDine :
    RecyclerView.Adapter<RclvProdukDine.ViewHolder> {
    val context: Context
    ...
    constructor(
        ...
        this.listMeja = listMeja
        this.order = order
        this.saveListProduk = listProduk
    }

    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(produk: Produk, meja: Meja, context: Context) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val meja = listMeja
        holder.bind(produk, meja, context)
            ...
            MaterialAlertDialogBuilder(context)
                ...
                .setPositiveButton(
                    ...
                    DialogInterface.OnClickListener { dialogInterface, i ->
                        val transaksi = SugarRecord.find(Transaksi::class.java,"status = ? and id_meja = ?","1", meja.id.toString()).firstOrNull()
